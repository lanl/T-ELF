...
def main(file_path, cols, n_jobs, n_nodes, verbose):
    ...
    nmfk_settings = config['nmfk']['decomposition_settings']
    ...
    df = pd.read_csv(os.path.join(input_path, fn))
    ...
    # decompose X
    dynamic_settings, all_params = find_param_combinations(decomposition_settings)
